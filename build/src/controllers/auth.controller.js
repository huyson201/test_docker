...
var login = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    var _req$body, email, password, user, compare, accessToken, _refreshToken;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 10:
            accessToken = (0, _utils.generateAccessToken)({
              id: user.id,
              uid: user.uid,
              email: user.email
            });
            _refreshToken = (0, _utils.generateRefreshToken)({
              id: user.id,
              uid: user.uid,
              email: user.email
            });
            res.cookie('auth.access_token', accessToken);
            res.cookie('auth.refresh_token', _refreshToken);
...
var refreshToken = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res, next) {
    var refresh_token, verify, token;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            refresh_token = req.cookies['auth.refresh_token'];
            _context8.prev = 1;
            verify = _jsonwebtoken["default"].verify(refresh_token, process.env.REFRESH_TOKEN_SECRET);
          ...
          case 5:
            token = (0, _utils.generateAccessToken)({
              id: verify.id,
              email: verify.email,
              uid: verify.uid
            });
